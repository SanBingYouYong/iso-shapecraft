...
def paths(exp_folder: str, output_py: str, suffix_py: str, config_json: str, render_folder: str, obj_folder: str):
    exp_folder = os.path.join(PROJECT_ROOT, 'exp', exp_folder)
...
def combine_and_run(exp_folder: str, output_py: str, 
    ...
    exp_folder, output_py, suffix_py, config_json, render_folder, obj_folder = paths(exp_folder, output_py, suffix_py, config_json, render_folder, obj_folder)
    combined_py = os.path.join(exp_folder, f"_combined_{os.path.basename(output_py).split('.')[0]}.py")
